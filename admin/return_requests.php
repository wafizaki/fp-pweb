                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select returnbook.BookId,returnbook.RollNo,Title,datediff(curdate(),Due_Date) as x from returnbook,book,record where returnbook.BookId=book.BookId and returnbook.BookId=record.BookId and returnbook.RollNo=record.RollNo";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <?php echo $bookid; ?>&id2=<?php echo $rollno; ?>
